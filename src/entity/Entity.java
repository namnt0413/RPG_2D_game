...
public class Entity {
	...
	public void generateParticle(Entity generator, Entity target) {
		...
		Particle p1 = new Particle(gp,generator,color,size,(int)speed,maxLife,-2,-1); 
		Particle p2 = new Particle(gp,generator,color,size,(int)speed,maxLife,2,-1); 
		Particle p3 = new Particle(gp,generator,color,size,(int)speed,maxLife,-2,1); 
		Particle p4 = new Particle(gp,generator,color,size,(int)speed,maxLife,2,1); 
